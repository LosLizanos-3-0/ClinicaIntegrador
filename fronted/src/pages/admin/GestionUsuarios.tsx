...
export default function GestionUsuarios() {
  ...
  const filtrados = useMemo(() => {
    ...
    return usuarios.filter(
      (u) =>
        (nombreCompletoDe(u).toLowerCase().includes(q) ||
            ...
            <>
              ...
              <div className="border rounded overflow-hidden">
                <div
                  ...
                  style={{
                    letterSpacing: ".03em",
                    gridTemplateColumns: COLUMNAS_TABLA_USUARIOS,
                  }}
                >
                  <span />
                  <span>Usuario</span>
                ...
                {paginados.map((u, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <span
                          className={`badge-soft ${ROL_COLOR[u.rol] ?? "badge-soft-gray"}`}
                        >
                          {u.rol}
                        </span>
                      </div>
